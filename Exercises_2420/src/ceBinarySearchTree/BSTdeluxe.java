...
/**
 *  The {@code BSTDeluxe} class represents an ordered symbol table of generic
 *  key-value pairs.
...
public class BSTdeluxe<Key extends Comparable<Key>, Value> {
    ...
    // return number of key-value pairs in BSTDeluxe rooted at x
    ...
    // Return key in BSTDeluxe rooted at x of given rank.
    ...
    /**
     * Returns the height of the BSTDeluxe (for debugging).
     *
     * @return the height of the BSTDeluxe (a 1-node tree has height 0)
     */
    public int height() {
        return height(root);
    }
    ...
    /**
     * Returns the keys in the BSTDeluxe in level order (for debugging).
     *
     * @return the keys in the BSTDeluxe in level order traversal
     */
    ...
    /**
     * Returns the keys in the BSTDeluxe in pre-order.
     *
     * @return the keys in the BSTDeluxe in pre-order traversal
     */
    ...
    private void preOrder(Node node, Queue<Key> q) {
    	if(node == null) return;
    	q.enqueue(node.key);
    ...
    /**
     * Returns the keys in the BSTDeluxe in in-order.
     *
     * @return the keys in the BSTDeluxe in in-order traversal
     */
    ...
    /**
     * Returns the keys in the BSTDeluxe in post-order.
     *
     * @return the keys in the BSTDeluxe in post-order traversal
     */
    ...
    private void postOrder(Node node, Queue<Key> q) {
    	if(node == null) return;
  ...
  /*************************************************************************
    *  Check integrity of BSTDeluxe data structure.
    ***************************************************************************/
    ...
    // is the tree rooted at x a BSTDeluxe with all keys strictly between min and max
    ...
    /**
     * Unit tests the {@code BSTDeluxe} data type.
     *
